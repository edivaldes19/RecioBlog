...
@Composable
fun NewPostsContent(paddingValues: PaddingValues, viewModel: NewPostViewModel = hiltViewModel()) {
    ...
    ConstraintLayout(
        ...
        Column(
            ...
            DefaultButton(
                ...
                icon = R.drawable.outline_post_add,
                enabled = viewModel.isEnabledNewPostButton
            )
        }
    }
}